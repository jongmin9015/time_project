...
- 3.3 (목) 근무자 1인 확진 결과 통보 * 근무일 : 2.27 (일)~2.28 (월) 김포 센터에서 근무하셨습니다.
- 3.3 (목) 근무자 1인 확진 결과 통보 * 근무일 : 2.27 (일)~2.28 (월) 김포 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 : 2.27(일)~3.1(화)  송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)  송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.28(월)~3.2(수)  송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.2(수)~3.3(목)  송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.1(화)  화도 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.1(화)~3.2(수)  화도 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.1(화)  화도 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.27(일)  김포 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.27(일)~2.28(월)  김포 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.1(화), 3.3(목)  김포 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.28(월)~3.2(수)  김포 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.28(월)~3.2(수) 송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  3.2(수) 송파 센터에서 근무하셨습니다.
- 3.4 (금) 근무자 1인 확진 결과 통보 * 근무일 :  2.27(일)~3.2(수) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 2.27(일)~3.1(화) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.3(목) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 2.28(월)~3.3(목) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 2.28(월)~3.3(목) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.3(목) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.2(수) 송파 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수) 김포 센터에서 근무하셨습니다.
- 3.5 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수)~3.4(금) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 2.27(일) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 2.27(일) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수)~3.4(금) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.3(목) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금)~3.5(토) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목)~3.4(금) 송파 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.4(금) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수)~3.3(목) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.3(목) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.1(화)~3.4(금) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수)~3.3(목) 김포 센터에서 근무하셨습니다.
- 3.6 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목) 김포 센터에서 근무하셨습니다.
...
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목)~3.4(금)송파 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토) 송파 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.2(수) 화도 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토)~3.6(일) 화도 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토)~3.6(일) 화도 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금)~3.6(일) 김포 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목)~3.6(일) 김포 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토) 김포 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.3(목), 3.5(토), 3.6(일) 김포 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 김포 센터에서 근무하셨습니다.
- 3.8 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토)~3.6(일) 김포 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일) 송파 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 화도 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 화도 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 화도 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 김포 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금)~3.7(월) 김포 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토)~3.7(월) 김포 센터에서 근무하셨습니다.
- 3.9 (수) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금)~3.6(일) 김포 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.9(수) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.9(수) 화도 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일)~3.7(월) 화도 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화) 죽전 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.5(토), 3.8(화) 김포 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일) 김포 센터에서 근무하셨습니다.
- 3.10 (목) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 김포 센터에서 근무하셨습니다.
