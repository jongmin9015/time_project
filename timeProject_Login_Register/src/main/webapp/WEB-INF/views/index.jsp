...
<head>
	...
	<title>회원가입</title>
	<script src="https://code.jquert.com/jquert-3.1.1.min.js"></script>
...
<body>
	<div class="container">
		<form method="post" action="./userRegister">
			<table class="table table-border table-hover" style="text-align: center; border 1px solid #ddd;">
				<thead>
					<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="password" id="userPassword2" name="userPassword2" maxLength="20" placeholder="비밀번호 확인"></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<div class="form-group" style="text-align: center; margin: 0 auto;">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-primart active">
										<input type="radio" name="userGender" autocomplete="off" value="남자" checked>남자
									</label>
									<label class="btn btn-primart active">
										<input type="radio" name="userGender" autocomplete="off" value="자">여자
									</label>
								</div>
							</div>
						</td>
