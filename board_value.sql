...
values (seq_board.nextval, 3, '1:1문의글', 10, '1:1문의의의', 'user');
...
values (seq_board.nextval, 2, 20, '다른 포장방법은 없나요?', '■ 컬리가 사용 중인 포장재
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '포장재를 회수하기도 하나요?', '■ 포장재 회수 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '배송 될 때는 어떻게 포장되어서 오나요?', '■ 포장법 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '	상품은 어떻게 포장되나요?', '■ 포장법 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '주문건이 1건 이상인데 한번에 묶어서(합해서) 배송해 주실 수 있나요?', '■ 묶음 배송 불가
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '	이 주소지가 배송 가능한지, 어떻게 배송되는 지역인지 궁금합니다.', '■ 나의 배송지, 배송 유형 확인하기
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '샛별지역인데, 택배배송으로 수령받고 싶어요 ( 택배지역 → 샛별배송 희망 )', '■ 샛별/택배 중, 특정 배송유형 지정 불가
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '	배송지역 검색 시, 배송 불가지역으로 조회 됩니다.', '	■ 배송불가 지역 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '	(택배배송) 택배지역인데 배송이 언제 되나요?', '■ 택배지역 배송일정 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 20, '	샛별배송/ 택배배송이 무엇인가요?', '마켓컬리는 고객님 배송지역에 따라 샛별배송과 택배배송으로 구분하여 상품을 배송합니다.
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '(카카오간편 로그인) 컬리 사용 계정이 여러 개인데, 모두 카카오톡으로 연동해서 합치고 싶습니다.', '■ 기존 아이디 1개만 연동 가능
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '(카카오간편 로그인) 수령지를 바꾸고 싶어요', '■ 배송지 변경 방법

- 배송지 수정은 [마이컬리>배송지 관리] 에서 직접 수정하실 수 있습니다.
', 'TimeShop');

insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '	(카카오간편 로그인) 카카오톡으로 기존 아이디 연동했는데, 회원정보를 바꾸고 싶어요', '■ 주소/회원정보 수정 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '(카카오간편 로그인) 컬리앱에서 카카오톡 로그인이 보이지 않아요', '■ 사용 기기의 운영체제에 따라 노출 여부 상이함
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '	회원 탈퇴를 하고 싶습니다.', '■ 탈퇴 방법 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '회원 탈퇴 후, 재가입이 가능한가요?', '■ 회원 재가입 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '	주문하지 않았는데, 주문완료 메시지 또는 배송완료 메시지를 받았습니다.', '■ 주문/배송완료 메시지 오수신
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 10, '회원가입에 제한이 있나요?', '■ 회원가입 조건
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(컬리패스) 취소는 어떻게 하나요?', '■ 취소방법
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '(컬리패스) 서비스 이용 기준이 있나요?', '	■ 컬리패스 서비스 이용 기준
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(컬리패스) 신용카드 잔고/한도 부족으로 정기 결제가 되지 않았습니다.', '■ 결제 실패 시
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(컬리패스) 신용카드가 정보가 변경이 있어 교체하고자 하는데 어떻게 결제방법을 바꿀 수 있나요?', '	■ 결제수단 변경
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '(컬리패스) 이사하면서,지역이 택배지역으로 바뀌었습니다. 동일하게 사용 할 수 있나요?', '■ 컬리패스 사용가능 지역
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(퍼플박스) 규격은 어떻게 되나요?', '■ 퍼플박스 규격
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(퍼플박스) 교환/환불 기준이 궁금합니다', '	■ 퍼플박스 교환/환불 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '	(퍼플박스) 박스로 배송되는 경우는 뭐죠?', '■ 품질저하 우려로 별도 포장재 배송
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 30, '(퍼플박스) 퍼플박스는 수거용인가요?', '	■ 미수거 상품
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 40, '상품 문의는 어디서 작성할 수 있나요?', '■ 상품 문의 작성 방법
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 40, '1:1 게시판으로 문의 남기는 방법은 없나요?', '■ 1:1게시판 상담 문의 방법
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 40, '	품절 된 상품은 언제 재입고 되나요?', '■ 재입고 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 40, '홈페이지 팝업창을 꼭 해제 해야하나요?', '	■ 팝업 차단 해제 방법
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 40, '장바구니에 담은 상품들은 계속 보존되나요?', '■ 장바구니 담기 저장 유효기간 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 50, '주문을 취소 하고 싶습니다.', '■ 주문취소 방법 안내
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 50, '환불 안내는 받았는데, 아직 카드사에서는 취소가 안되었어요', '■ 카드 취소 시, 유의사항
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 50, '상품불량인 경우, 교환(반품) 기준이 궁금합니다.', '■ 상품에 문제가 있는 경우
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 50, '단순변심/주문착오로 인한, 교환(반품) 기준이 궁금합니다.', '■ 단순 변심, 주문 착오의 경우
...
insert into tbl_board (bno, bgno, categoryNo, title, content, writer)
values (seq_board.nextval, 2, 50, '교환(반품) 어떻게 진행 되나요?', '■ 교환(반품) 진행 방법
...
--공지사항
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [데비마이어] 지니어스 스펀지 그린 1EA 외 10건 (2022 3. 8 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [만토바] 바질 페스토 외 4건 (2022 3. 7 ~)', '
고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 근무자 코로나19 확진 관련 안내_ 03.06 업데이트', '안녕하세요. 고객님. 마켓컬리입니다.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [농심] 새우깡 90g 외 16건 (2022 3. 3 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [추억의 국민학교 떡볶이] 컵볶이 외 11 종 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [맑은물에] 국산 촌두부 (2022 3. 11 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [바이탈에센셜] 동결건조 미노스 외 26건 (2022 3. 8 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격변경공지] [La bocca] 프랑스 디저트 세트 외 76건 (2022. 3. 7 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [델리치오] 목초육 안심 스테이크 외 13건 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인하공지] [KF365] 특란 2종 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [우드앤브릭] 올리브 치아바타 외 9건 (2022 3. 14 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [햇반] 솥반 4종 (2022 3. 11 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [풀무원]모짜렐라 핫도그 4종 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [선물세트] LOMA 너리싱샴푸1L+너리싱 컨디셔너 1L 외 57건 (2022 3. 11 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 근무자 코로나19 확진 관련 안내_ 03.10 업데이트', '안녕하세요. 고객님. 마켓컬리입니다.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 갤럭시 S22 사전예약 이벤트 당첨자 안내', '안녕하세요 고객님, 마켓컬리입니다.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [아트위드미] 유기농참밤 60G 외 2건 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [마이리틀타이거] 핑크퐁 아기상어케이크 (2022 3. 11 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인하공지] [설성목장] 무항생제 한우 어린이 육포 (2022 3. 15 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [비비드키친] 4종 (2022 3. 11 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] 딥스 해양심층수 골드 2L 1박스(6개입) 외 2건 (2022 3. 10 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [일상생활] 안전한 향균 코털가위 외 10건 (2022 3. 16 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [지위픽] DOG 에어드라이 사슴고기 1kg 외 52건 (2022 3. 18 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 근무자 코로나19 확진 관련 안내_ 03.15 업데이트', '안녕하세요. 고객님. 마켓컬리입니다.
...
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일)~3.9(수) 화도 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일) 화도 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.9(수) 화도 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.8(화) 화도 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.9(수) 김포 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일)~3.9(수) 김포 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.6(일)~3.7(월) 김포 센터에서 근무하셨습니다.
- 3.11 (금) 근무자 1인 확진 결과 통보 * 근무일 : 3.4(금)~3.5(토) 김포 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화), 3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.11(금) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.9(수) 송파 센터에서 근무하셨습니다.
- 3.12 (토) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.9(수) 송파 센터에서 근무하셨습니다.
...
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.10(목) 송파 센터에서 근무하셨습니다.
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.9(수)~3.11(금) 송파 센터에서 근무하셨습니다.
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.9(수) 송파 센터에서 근무하셨습니다.
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.13 (일) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토)~3.13(일) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.12(토) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일) 송파 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목) 김포 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.9(수) 김포 센터에서 근무하셨습니다.
- 3.14 (월) 근무자 1인 확진 결과 통보 * 근무일 : 3.7(월)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.12(토) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일)~3.14(월) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.12(토) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금)~3.13(일) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.14(월) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.14(월) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일)~3.14(월) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.13(일)~3.15(화) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.15(화) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.15(화) 송파 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금), 3.12(토), 3.14(월) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.13(금) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.9(수), 3.11(금), 3.12(토) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.9(수)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.8(화)~3.10(목) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.11(금) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.11(금), 3.12(토), 3.14(월) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.12(토) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.12(토) 김포 센터에서 근무하셨습니다.
- 3.15 (화) 근무자 1인 확진 결과 통보 * 근무일 : 3.10(목)~3.12(토) 김포 센터에서 근무하셨습니다.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [온맘] 엄마의식탁 김자반 (2022 3. 18 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [진미] 고추장/간장 외 19 건 (2022 3. 16 ~)', '
고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [오이뮤] 향분낭 무화과 외 2건 (2022 3. 19 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [풀무원다논] 떠먹는 액티비아 딸기 80g*4입 외 4건 (2022 3. 17 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [씨클레버] 오븐에 구운 먹태 외 7 건 (2022 3. 17 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [페이브] 블렌드 원두(블랙 블렌드) 외 12건 (2022 3. 21 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [진실된손맛] 한우사골 도가니탕 외 2건 (2022 3. 19 ~)', '
고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [하선정] 다진마늘 150g외 1 건 (2022 3. 24 ~)', '
고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[가격인상공지] [Kiri] 끼리 블루베리 크림치즈 찰떡 6입 외 8건 (2022 3. 22 ~)', '고객님, 안녕하세요.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 포장재 회수 서비스 안내', '고객님, 안녕하세요. 마켓컬리 입니다.
...
insert into tbl_board(bno, bgno, categoryNo, title, content, writer)
values(seq_board.nextval, 1, 0, '[마켓컬리] 택배 배송 주문 불가 지역 안내 (2022.3.16 업데이트)', '
안녕하세요.고객님
TimeShop 입니다.
